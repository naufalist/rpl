...
function cekKarakter($data){
    $karakteristik = [
        ...
        "vshaped" => [
            "kebutuhan_awal" => "dapat dijelaskan", // revisi bu sofi {dapat dijelaskan}
        ...
        "spiral" => [
            ...
            "kompleksitas" => "kompleks#sangat kompleks", // revisi bu sofi {kompleks, sangat kompleks}
            "waktu_delivery" => "1 - 3 bulan",
            "jumlah_tim" => "> 12 orang",
        ...
        "scrum" => [
            "kebutuhan_awal" => "dapat dijelaskan#tidak dapat dijelaskan", // koreksi bu sofi {jelas, belum jelas}
            "kompleksitas" => "kompleks",
            "waktu_delivery" => "< 1 bulan", // koreksi bu sofi {< 1 bulan}
            "jumlah_tim" => "> 12 orang",
            "keterampilan_tim" => "berpengalaman",
            "klien_terlibat_langsung" => "terlibat"
    ...
    foreach ($metodologi as $metode => $poin) {
        foreach ($karakteristik[$metode] as $karakter => $nilaiKarakter) {
            if (strpos($nilaiKarakter, "#") !== false) {
                $nilaiKarakterArr = explode("#", $nilaiKarakter);
                for ($i = 0; $i < count($nilaiKarakterArr); $i++) { 
                    if ($data[$karakter] == $nilaiKarakterArr[$i]) {
                        $metodologi[$metode]++;
                    }
                }
            } else {
    ...
    arsort($metodologi);
    $metodologi = array_slice($metodologi, 0 ,3);
    ...
    <script>
        function metodologi(metodologi)
        {
            var incremental = [
                ...
                "<ul><li><a href='https://sis.binus.ac.id/2019/07/02/software-development-model-incremental-model/' target='_blank'>https://sis.binus.ac.id/</a></li><li><a href='https://www.angon.co.id/news/uncategorized/model-model-pengembangan-perangkat-lunak-beserta-contoh-penerapannya' target='_blank'>https://www.angon.co.id/</a></li></ul>",
            ]
            ...
            var vshaped = [
                ...
                "<ul><li><a href='https://www.dictio.id/t/apa-yang-dimaksud-dengan-model-v-dalam-pengembangan-perangkat-lunak/15046/2' target='_blank'>https://www.dictio.id/</a></li><li><a href='http://ejournal.ikado.ac.id/index.php/teknika/article/download/48/38' target='_blank'>http://ejournal.ikado.ac.id/</a></li></ul>",
            ]
            ...
            var spiral = [
                ...
                "<ul><li><a href='https://sis.binus.ac.id/2019/04/29/pengembangan-sistem-spiral-model/' target='_blank'>https://sis.binus.ac.id/</a></li><li><a href='https://salamadian.com/metode-pengembangan-perangkat-lunak/' target='_blank'>https://salamadian.com/</a></li></ul>",
            ]
            ...
            var rad = [
                ...
                "<ul><li><a href='https://www.dictio.id/t/apa-yang-dimaksud-dengan-rapid-application-development/15023/2' target='_blank'>https://www.dictio.id/</a></li><li><a href='https://webreferensi.com/metode-rapid-application-development/' target='_blank'>https://webreferensi.com/</a></li></ul>",
            ]
            ...
            var prototyping = [
                ...
                "<ul><li><a href='https://medium.com/@ameliamanurung07/prototyping-a4aff5bdb558' target='_blank'>https://medium.com/@ameliamanurung07/</a></li><li><a href='https://webreferensi.com/metode-prototyping/' target='_blank'>https://webreferensi.com/</a></li><li><a href='http://labgis.si.fti.unand.ac.id/metode-pengembangan-perangkat-lunak/' target='_blank'>http://labgis.si.fti.unand.ac.id/</a></li></ul>",
            ]
            ...
            var scrum = [
                ...
                "<ul><li><a href='https://www.dewaweb.com/blog/Scrum-methodology-panduan-project-management/' target='_blank'>https://www.dewaweb.com/blog/</a></li><li><a href='https://rachmat.id/kelebihan-dan-kekurangan-Scrum/' target='_blank'>https://rachmat.id/</a></li></ul>",
            ]
            ...
            var extreme = [
                ...
                "<ul><li><a href='https://medium.com/@mikesebastian/extreme-programming-c715e6b8e0e9' target='_blank'>https://medium.com/@mikesebastian/</a></li><li><a href='https://www.it-jurnal.com/apa-itu-extreme-programming/' target='_blank'>https://www.it-jurnal.com/</a></li></ul>",
            ]
            ...
            $("#metodologi .modal-ket4").html(metode[4])
            $("#metodologi").modal()
        }
                    ...
                    <div class="card mb-2 shadow-sm">
                        ...
                        <div id="result" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            ...
                            <div class="alert alert-info font-weight-bold">
                                    Hasil rekomendasi ini diperoleh dari seluruh pengecekan metodologi yang tersedia, tidak terpaku oleh salah satu karakteristik.
                            </div>
                                <?php
                                ...
                                if (isset($_POST["subform"])) {
                                    ...
                                    <table class="table table-sm">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">Nama Metodologi (% rekomendasi)</th>
                                    ...
                                    foreach ($response as $metode => $poin) {
                                        if ($poin !== 0) {
                                            echo '<tr>
                                                    <th scope="row">'.$i++.'</th>
                                                    <td>'.ucwords($metode).' ('.round(($poin/6*100),1,PHP_ROUND_HALF_UP).' %)</td>
                                                    <td>
    ...
    <footer id="footer" class="mt-4 fixed-bottom">
        <div class="container-fluid py-3 small text-black-50" style="border-top: 1px solid rgb(221, 221, 221);">
            <div class="row">
                ...
                <div class="col-6 text-right"> Version <strong> 20201010.1 </strong>
                </div>
            </div>
        </div>
    </footer>
